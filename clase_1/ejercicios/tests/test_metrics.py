import numpy as np
import pytest
from clase_1.ejercicios.src.basic_metrics_v2 import Precision, Recall, Accuracy
from clase_1.ejercicios.src.avg_q_precision_v2 import QueryMeanPrecision
from clase_1.ejercicios.src.metrics_iteration import IterateMetrics
